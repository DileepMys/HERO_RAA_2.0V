/* @file FILE NAME */
#ifndef BLE_CALL_MODULE_CFG_H
#define BLE_CALL_MODULE_CFG_H
...
#define BLE_GET_IGN_POSITION()    Sys_Service_Get_Ignition_State();
#define BLE_GET_LOW_VOLTAGE_STATE()   Sys_Service_Get_Low_Voltage_State();
#define BLE_GET_HIGH_VOLTAGE_STATE()   Sys_Service_Get_High_Voltage_State();
