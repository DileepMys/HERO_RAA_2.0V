/* @GPIO */
#ifndef FOG_LAMP_CFG_H
#define FOG_LAMP_CFG_H
 ...
 *  @brief
 *
 *  File name                       : Swc_TT_Fog_Lamp_cfg.h
 *  Version                         : V1.0.1
...
***********************************************************************************************************************/
/*
* @brief: This variable is used to configure the input as LOW
* @Unit:  NA
* @Resolution: NA
* @Range: NA
* @Applicability: NA
...
/*
* @brief: This variable is used to configure the input as HIGH
* @Unit:  NA
* @Resolution: NA
* @Range: NA
* @Applicability: NA
...
/*
* @brief: This variable is used to configure hardware input for fog lamp
* @Unit:  NA
* @Resolution: NA
* @Range: NA
* @Applicability: NA
* @Note:
*/
#define GET_HARDWARE_INPUT_FOG_LAMP	NULL
