...
*/
/*
* @brief: This trip timer configuration enable is ON then the flag changed into OFF condition 
* @Unit:  NA
* @Resolution: NIL
* @Range: NA
* @Applicability: NA
* @Note:
*/
#if (SWC_TT_CONFIGURATION_ENABLE == STD_ON)

   #define SWC_TT_CONFIGURATION_STATUS           (STD_OFF)
