...
- {id: ARM_PLL_CLK.outFreq, value: 1.2 GHz}
...
- {id: ELCDIF_CLK_ROOT.outFreq, value: 84/13 MHz}
...
- {id: GC355_CLK_ROOT.outFreq, value: 336 MHz}
...
- {id: PLL_VIDEO_CLK.outFreq, value: 672 MHz}
- {id: PLL_VIDEO_SS_MODULATION.outFreq, value: 417.6/13 kHz}
- {id: PLL_VIDEO_SS_RANGE.outFreq, value: 3.25/2 MHz}
...
- {id: ANADIG_PLL.PLL_VIDEO.num, value: '0', locked: true}
- {id: ANADIG_PLL.PLL_VIDEO_POST_DIV.scale, value: '1', locked: true}
- {id: ANADIG_PLL.PLL_VIDEO_SS_MOD_DIV.scale, value: '130000'}
- {id: ANADIG_PLL.PLL_VIDEO_SS_STEP.scale, value: '174', locked: true}
- {id: ANADIG_PLL.PLL_VIDEO_SS_STOP.scale, value: '65000', locked: true}
- {id: ANADIG_PLL.SYS_PLL1_BYPASS.sel, value: ANADIG_OSC.OSC_24M}
- {id: ANADIG_PLL.SYS_PLL2.denom, value: '13650', locked: true}
- {id: ANADIG_PLL.SYS_PLL2.div, value: '22'}
- {id: ANADIG_PLL.SYS_PLL2.num, value: '0'}
- {id: ANADIG_PLL.SYS_PLL2_SS_DIV.scale, value: '13650'}
...
- {id: ANADIG_PLL_PLL_VIDEO_SS_ENABLE_CFG, value: Enabled}
...
- {id: CCM.CLOCK_ROOT4.MUX.sel, value: ANADIG_OSC.OSC_24M}
- {id: CCM.CLOCK_ROOT41.DIV.scale, value: '1', locked: true}
...
- {id: CCM.CLOCK_ROOT69.DIV.scale, value: '104', locked: true}
- {id: CCM.CLOCK_ROOT69.MUX.sel, value: ANADIG_PLL.PLL_VIDEO_CLK}
- {id: CCM.CLOCK_ROOT8.DIV.scale, value: '240'}
- {id: CLK_ROOT7_INIT_Config, value: disabled}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
...
const clock_sys_pll2_config_t sysPll2Config_BOARD_BootClockRUN =
    {
        .mfd = 13650,                             /* Denominator of spread spectrum */
        .ss = NULL,                               /* Spread spectrum parameter */
        .ssEnable = false,                        /* Enable spread spectrum or not */
    };

clock_pll_ss_config_t videoPllSsConfig_BOARD_BootClockRUN =
    {
        .stop = 65000,                            /* Stop value to get frequency change */
        .step = 174,                              /* Step value to get frequency change */
    };
...
const clock_video_pll_config_t videoPllConfig_BOARD_BootClockRUN =
    {
        ...
        .ss = &videoPllSsConfig_BOARD_BootClockRUN,/* Spread spectrum parameter */
...
void BOARD_BootClockRUN(void)
{
    ...
    /* Configure M4 using OSC_24M */
#if __CORTEX_M == 4
    rootCfg.mux = kCLOCK_M4_ClockRoot_MuxOsc24MOut;
    rootCfg.div = 1;
    CLOCK_SetRootClock(kCLOCK_Root_M4, &rootCfg);
#endif
    ...
    /* Configure SEMC using OSC_24M */
#ifndef SKIP_SEMC_INIT
    rootCfg.mux = kCLOCK_SEMC_ClockRoot_MuxOsc24MOut;
    rootCfg.div = 3;
    ...
    /* Configure LCDIF using PLL_VIDEO_CLK */
    rootCfg.mux = kCLOCK_LCDIF_ClockRoot_MuxVideoPllOut;
    rootCfg.div = 104;
