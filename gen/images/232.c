...
#ifndef LV_ATTRIBUTE_IMG__IMG_TRIP_DOWN_ARROW_9X9
#define LV_ATTRIBUTE_IMG__IMG_TRIP_DOWN_ARROW_9X9
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_IMG__IMG_TRIP_DOWN_ARROW_9X9 uint8_t _img_trip_down_arrow_9x9_map[] = {
...
const lv_img_dsc_t _img_trip_down_arrow_9x9 = {
  .header.always_zero = 0,
  .header.w = 9,
  .header.h = 9,
  .data_size = 81 * LV_COLOR_SIZE / 8,
  .header.cf = LV_IMG_CF_TRUE_COLOR,
  .data = _img_trip_down_arrow_9x9_map,
};
