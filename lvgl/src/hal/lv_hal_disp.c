...
#include "lvgl/src/draw/nxp_pxp/lv_gpu_nxp_pxp_osa.h"
#include "lvgl/src/draw/nxp_pxp/lv_gpu_nxp_pxp.h"
#include "lvgl/src/draw/nxp_pxp/lv_draw_pxp.h"
#include "lvgl/src/draw/nxp_vglite/lv_draw_vglite.h"
