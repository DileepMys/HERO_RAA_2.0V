...
static inline lv_color_t lv_color_orange(void)
{
    return lv_color_make(0xFB, 0x93, 0x00);
}
/* New Orange*/
static inline lv_color_t lv_color_New_orange(void)
{
    return lv_color_make(0xFB, 0x96, 0x00);
}

static inline lv_color_t lv_color_night_orange(void)
{
    return lv_color_make(0xFF, 0x78, 0x00);
}
static inline lv_color_t lv_color_Grey(void)
{
    return lv_color_make(0x20, 0x20, 0x20);
}
static inline lv_color_t lv_color_Intermediate_Grey(void)
{
    return lv_color_make(0x20, 0x20, 0x20);
}
...
static inline lv_color_t lv_color_Grey_Setting(void)
{
    return lv_color_make(0xBF, 0xBF, 0xBF);
}

static inline lv_color_t lv_color_Day_Grey(void)
{
    return lv_color_make(0x11, 0x11, 0x11);
}

static inline lv_color_t lv_color_Daymode_Greytext(void)
{
    return lv_color_make(0xB8, 0xB8, 0xB8);
}

static inline lv_color_t lv_color_Daymode_Blacktext(void)
{
    return lv_color_make(0x00, 0x00, 0x00);
}

static inline lv_color_t lv_color_Nightmode_Whitetext(void)
{
    return lv_color_make(0xFF, 0xFF, 0xFF);
}

static inline lv_color_t lv_color_Nightmode_Greytext(void)
{
    return lv_color_make(0x70, 0x6f, 0x6f);
}
